(module
  ...
  (global $free_mem (mut i32) (i32.const 76))
  ...
  (data (i32.const 24) "Test: Three X's in different colors and thicknesses\00")  ;; String literal
