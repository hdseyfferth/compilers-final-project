(module
  ...
  (global $free_mem (mut i32) (i32.const 56))


  (data (i32.const 0) "blue\00")  ;; String literal
  (data (i32.const 5) "#000080\00")  ;; String literal
  (data (i32.const 13) "Test: Blue circle with dark blue perimeter\00")  ;; String literal
  ...
  (func $Fun13 (result i32)
    ...
    (i32.const 13)  ;; String literal at memory position 13
