(module
  ...
  (global $free_mem (mut i32) (i32.const 43))


  (data (i32.const 0) "Test: Character literals.\00")  ;; String literal
  (data (i32.const 26) "Is this an A? : \00")  ;; String literal
