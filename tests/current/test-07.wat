(module
  ...
  (global $free_mem (mut i32) (i32.const 114))
  ...
  (data (i32.const 0) "orange\00")  ;; String literal
  (data (i32.const 7) "purple\00")  ;; String literal
  (data (i32.const 14) "yellow\00")  ;; String literal
  (data (i32.const 21) "pink\00")  ;; String literal
  (data (i32.const 26) "brown\00")  ;; String literal
  (data (i32.const 32) "gray\00")  ;; String literal
  (data (i32.const 37) "#000080\00")  ;; String literal
  (data (i32.const 45) "#800000\00")  ;; String literal
  (data (i32.const 53) "#008000\00")  ;; String literal
  (data (i32.const 61) "Test: Use global variables to auto-place the next X.\00")  ;; String literal
  ...
  (func $Fun14 (result i32)
    ...
    ;; Call function 'DrawX'
    (i32.const 7)  ;; String literal at memory position 7
    (call $Fun13)  ;; Call 'DrawX'
    (drop) ;; Result not used.
    ;; Call function 'DrawX'
    (i32.const 14)  ;; String literal at memory position 14
    (call $Fun13)  ;; Call 'DrawX'
    (drop) ;; Result not used.
    ;; Call function 'DrawX'
    (i32.const 21)  ;; String literal at memory position 21
    (call $Fun13)  ;; Call 'DrawX'
    (drop) ;; Result not used.
    ;; Call function 'DrawX'
    ...
    (drop) ;; Result not used.
    ;; Call function 'DrawX'
    (i32.const 32)  ;; String literal at memory position 32
    (call $Fun13)  ;; Call 'DrawX'
    (drop) ;; Result not used.
    ;; Call function 'DrawX'
    (i32.const 37)  ;; String literal at memory position 37
    (call $Fun13)  ;; Call 'DrawX'
    (drop) ;; Result not used.
    ;; Call function 'DrawX'
    ...
    (drop) ;; Result not used.
    ;; Call function 'DrawX'
    (i32.const 53)  ;; String literal at memory position 53
    (call $Fun13)  ;; Call 'DrawX'
    (drop) ;; Result not used.
